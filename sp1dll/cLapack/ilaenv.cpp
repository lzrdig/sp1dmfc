...
/*     ISPEC = 1:  block size   
	...
	} else if (strncmp(c3, "QRF", 3) == 0 || strncmp(c3, 
		"RQF", 3) == 0 || strncmp(c3, "LQF", 3) == 0 || 
		strncmp(c3, "QLF", 3)== 0) {
	    if (sname) {
		nb = 32;
	    } else {
	...
	if (*(unsigned char *)c3 == 'G') {
	    if (strncmp(c4, "QR", 2) == 0 || strncmp(c4, "RQ", 
		    2) == 0 || strncmp(c4, "LQ", 2) == 0 || strncmp(c4, "QL", 2) ==
		     0 || strncmp(c4, "HR", 2) == 0 || strncmp(
		    c4, "TR", 2) == 0 || strncmp(c4, "BR", 2) == 0) {
		nb = 32;
	    }
...
/*     ISPEC = 2:  minimum block size */
    ...
    nbmin = 2;
    if (strncmp(c2, "GE", 2) == 0) {
	if (strncmp(c3, "QRF", 3) == 0 || strncmp(c3, "RQF", 3) == 0 || 
		strncmp(c3, "LQF", 3) == 0 || strncmp(c3, "QLF", 3) == 0)
		 {
	    if (sname) {
		nbmin = 2;
	    } else {
